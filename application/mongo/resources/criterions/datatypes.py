...
from application.resources.datatypes import CLCriterion
...
class MongoCLCriterion(CLCriterion):

    @staticmethod
    def config_type() -> t.Type[MongoResourceConfig]:
        return MongoCLCriterionConfig
    ...
    def canonical_typename(cls) -> str:
        return CLCriterion.canonical_typename()
