...
replay_5000_strategy_name = 'replay_5000_strategy'
replay_5000_strategy_build = generic_strategy_builder(
    'Replay',
    STD_CIFAR_TRAIN_MB_SIZE,
    STD_CIFAR_TRAIN_EPOCHS * 2,
    STD_CIFAR_EVAL_MB_SIZE,
...
replay_5000_experiment_name = 'replay_5000_experiment'
replay_5000_experiment_build = generic_experiment_builder(replay_5000_strategy_name, benchmark_name)
...
class SplitCIFAR100Test(BaseClassicBenchmarkExperimentTestCase):
    ...
    # redefined since a test with cifar 100 could take a lot of time
    @property
    ...
    def get_benchmark_name(self) -> str:
        return 'split_cifar100_8_epochs_replay5000'
    ...
    experiment_data = [
        ...
        {
            'folder': 'replay_5000',
            'strategy_name': replay_5000_strategy_name,
            'strategy_build': replay_5000_strategy_build,
            'experiment_name': replay_5000_experiment_name,
            'experiment_build': replay_5000_experiment_build,
        },
        {
            'folder': 'lwf',
