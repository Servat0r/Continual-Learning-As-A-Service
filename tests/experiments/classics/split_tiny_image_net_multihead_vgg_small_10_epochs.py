...
class SplitTinyImageNetMultiHeadVGGSmallTest(BaseClassicBenchmarkExperimentTestCase):
    ...
    def get_benchmark_name() -> str:
        return 'split_tiny_imagenet_multihead_vggsmall_10_epochs'
